...
class WebSearch:
	def __init__(self, key, resultsNumber = 10, searchType = "Web"):
	...
	def makeQuery(self, query):
		...
		url = 'https://api.datamarket.azure.com/Data.ashx/Bing/Search/'+self.searchType+'?Query=%27'+query+'%27&$top='+str(self.resultsNumber)+'&$format=json'
